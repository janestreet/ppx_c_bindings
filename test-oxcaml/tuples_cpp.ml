...
(* just copy the non cpp tests since we're just smoke testing the syntax works as
   expected... *)
(*$ Ppx_c_bindings_test_oxcaml_cinaps_helpers.include_file ~file:"tuples.ml" [] *)
open! Core
...
let%expect_test "unboxed tuple return: #( int value * int Ox.Ptr.Ext.t )" =
  let tuple =
    [%c.no_alloc
      ({| return { Val_int(63005), ( void* )0x64019 }; |}
...
let%expect_test "unboxed tuple return: #( int value * int Ox.Addr.Ext.t )" =
  let tuple =
    [%c.no_alloc
      ({| return { Val_int(63005), ( void* )0x64021 }; |}
...
let%expect_test "unboxed tuple return: #( Ox.u64 * int Ox.Ptr.Ext.t )" =
  let tuple =
    [%c.no_alloc
      ({| return { 64013, ( void* )0x64019 }; |} : #(Ox.u64 * int Ox.Ptr.Ext.t))]
  in
...
let%expect_test "unboxed tuple return: #( Ox.u64 * int Ox.Addr.Ext.t )" =
  let tuple =
    [%c.no_alloc
      ({| return { 64013, ( void* )0x64021 }; |} : #(Ox.u64 * int Ox.Addr.Ext.t))]
  in
...
let%expect_test "unboxed tuple return: #( Ox.i64 * int Ox.Ptr.Ext.t )" =
  let tuple =
    [%c.no_alloc
      ({| return { -64014, ( void* )0x64019 }; |} : #(Ox.i64 * int Ox.Ptr.Ext.t))]
  in
...
let%expect_test "unboxed tuple return: #( Ox.f64 * int Ox.Ptr.Ext.t )" =
  let tuple =
    [%c.no_alloc
      ({| return { 64.016, ( void* )0x64019 }; |} : #(Ox.f64 * int Ox.Ptr.Ext.t))]
  in
...
let%expect_test "unboxed tuple return: #( Ox.mem * Ox.mem )" =
  let tuple =
    [%c.no_alloc
      ({| return { ( void* )0x64018, ( void* )0x64018 }; |} : #(Ox.mem * Ox.mem))]
  in
...
let%expect_test "unboxed tuple return: #( Ox.mem * int Ox.Ptr.Ext.t )" =
  let tuple =
    [%c.no_alloc
      ({| return { ( void* )0x64018, ( void* )0x64019 }; |}
...
let%expect_test "unboxed tuple return: #( Ox.mem * int Ox.Addr.Ext.t )" =
  let tuple =
    [%c.no_alloc
      ({| return { ( void* )0x64018, ( void* )0x64021 }; |}
...
let%expect_test "unboxed tuple return: #( int Ox.Ptr.Ext.t * int value )" =
  let tuple =
    [%c.no_alloc
      ({| return { ( void* )0x64019, Val_int(63005) }; |}
...
let%expect_test "unboxed tuple return: #( int Ox.Ptr.Ext.t * Ox.u64 )" =
  let tuple =
    [%c.no_alloc
      ({| return { ( void* )0x64019, 64013 }; |} : #(int Ox.Ptr.Ext.t * Ox.u64))]
  in
...
let%expect_test "unboxed tuple return: #( int Ox.Ptr.Ext.t * Ox.i64 )" =
  let tuple =
    [%c.no_alloc
      ({| return { ( void* )0x64019, -64014 }; |} : #(int Ox.Ptr.Ext.t * Ox.i64))]
  in
...
let%expect_test "unboxed tuple return: #( int Ox.Ptr.Ext.t * Ox.f64 )" =
  let tuple =
    [%c.no_alloc
      ({| return { ( void* )0x64019, 64.016 }; |} : #(int Ox.Ptr.Ext.t * Ox.f64))]
  in
...
let%expect_test "unboxed tuple return: #( int Ox.Ptr.Ext.t * Ox.mem )" =
  let tuple =
    [%c.no_alloc
      ({| return { ( void* )0x64019, ( void* )0x64018 }; |}
...
let%expect_test "unboxed tuple return: #( int Ox.Addr.Ext.t * int value )" =
  let tuple =
    [%c.no_alloc
      ({| return { ( void* )0x64021, Val_int(63005) }; |}
...
let%expect_test "unboxed tuple return: #( int Ox.Addr.Ext.t * Ox.u64 )" =
  let tuple =
    [%c.no_alloc
      ({| return { ( void* )0x64021, 64013 }; |} : #(int Ox.Addr.Ext.t * Ox.u64))]
  in
...
let%expect_test "unboxed tuple return: #( int Ox.Addr.Ext.t * Ox.mem )" =
  let tuple =
    [%c.no_alloc
      ({| return { ( void* )0x64021, ( void* )0x64018 }; |}
