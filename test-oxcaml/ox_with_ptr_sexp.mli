...
module Ptr : sig
  module Ext : sig
    type 'a t = 'a Ox.Ptr.Ext.t [@@deriving sexp_of]

    module Imm : sig
      type 'a t = 'a Ox.Ptr.Ext.Imm.t [@@deriving sexp_of]
    end
  end
end
...
module Addr : sig
  module Ext : sig
    type 'a t = 'a Ox.Addr.Ext.t [@@deriving sexp_of]

    module Imm : sig
      type 'a t = 'a Ox.Addr.Ext.Imm.t [@@deriving sexp_of]
    end
  end
end
